    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('language', models.CharField(blank=True, choices=[('es', 'Español'), ('li', 'Lengua Indígena'), ('en', 'Inglés'), ('fr', 'Francés')], help_text='Select the book language', max_length=2)),
                ('author', models.ForeignKey(null=True, on_delete=django.db.models.deletion.RESTRICT, to='catalogo.author')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='book',
            name='genre',
            field=models.ManyToManyField(help_text='Select a genre for this book', to='catalogo.genre'),
        ),
    ]
